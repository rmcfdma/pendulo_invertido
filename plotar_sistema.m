...
%% Glassário de variáveis
% tipo -> tipo de simulação
...
switch tipo
    ...
    case 'dois_sem_filtragem_sem_lqr'  
        ...
        legend(velocidade_carrinho,legenda1,legenda2,'FontSize',v); % Legenda do gráfico
        xlabel(velocidade_carrinho,'Tempo [s]','FontSize',v);           % Texto do eixo x
        ylabel(velocidade_carrinho,'Velocidade do Carrinho [m/s]','FontSize',v) % Texto do eixo y
        grid(velocidade_carrinho,'on');                                 % Habilita a grade
        ...
        velocidade_haste = nexttile;                                      % Gráfico do sinal de controle para um sistema
        p4_a = plot(velocidade_haste,t1,(180/pi)*x1(4,:),'LineWidth',w);  % Plot da velocidade angular do sistema 1 
        hold(velocidade_haste,'on');                                      % Retém o gráfico
        p4_b = plot(velocidade_haste,t2,(180/pi)*x2(4,:),'LineWidth',w);  % Plot da velocidade angular do sistema 2 
        legend(velocidade_haste,legenda1,legenda2,'FontSize',v); % Legenda do gráfico
        xlabel(velocidade_haste,'Tempo [s]','FontSize',v);                % Texto do eixo x
        ylabel(velocidade_haste,'Velocidade da Haste - [graus/s]','FontSize',v); % Texto do eixo y
        grid(velocidade_haste,'on');                                      % Habilita a grade
        hold(velocidade_haste,'off');                                     % Libera o gráfico
    ...
    case 'kf_ekf_sem_ruido'       
         ...
         p3_b = plot(velocidade_carrinho,t2,x2(2,:),'LineWidth',w);      % Plot da velocidade linear do sistema 2
         p3_c = plot(velocidade_carrinho,t3,x3(2,:),'LineWidth',w);      % Plot da velocidade linear do sistema 3
         legend(velocidade_carrinho,'Esperança',legenda2,legenda3,'FontSize',v); % Legenda do gráfico
         xlabel(velocidade_carrinho,'Tempo [s]','FontSize',v);           % Texto do eixo x
         ylabel(velocidade_carrinho,'Velocidade do Carrinho [m/s]','FontSize',v) % Texto do eixo y
         grid(velocidade_carrinho,'on');                                 % Habilita a grade
         ...
         legend(velocidade_angular,'Esperança',legenda2,legenda3,'FontSize',v); % Legenda do gráfico
         xlabel(velocidade_angular,'Tempo [s]','FontSize',v);                % Texto do eixo x
         ...
         p6_a = plot(erro_estimativa1,t1,e(1,:)','LineWidth',w);         % Plot do erro de estimativa da posição do carrinho entre o sistema 1 e seus estimador  ,'-r'
         hold(erro_estimativa1,'on');                                    % Retém o gráfico % Libera o gráfico
         p6_b = plot(erro_estimativa1,t1,e(2,:)','LineWidth',w);         % Plot do erro de estimativa do ângulo da haste entre o sistema 1 e seus estimador  ,'-r' 1':b',
         ...
         ylabel(erro_estimativa1,strcat('Erro de Estimativa',char(160),'[',legenda2,']'),'FontSize',v); % Texto do eixo y
         grid(erro_estimativa1,'on');                                    % Libera o gráfico
         
         erro_estimativa2 = nexttile;                                    % Gráfico dos sinais de erro para o ângulo da haste
         p7_a = plot(erro_estimativa2,t1,e2(1,:)','LineWidth',w);        % Plot do erro de estimativa da posição do carrinho entre o sistema 1 e seu estimador  ,'-r'
         hold(erro_estimativa2,'on');                                    % Retém o gráfico
         p7_b = plot(erro_estimativa2,t1,e2(2,:)','LineWidth',w);        % Plot do erro de estimativa do ângulo da haste entre o sistema 1 e seu estimador  ,'-r' 1':b',
         ...
         ylabel(erro_estimativa2,strcat('Erro de Estimativa',char(160),'[',legenda3,']'),'FontSize',v); % Texto do eixo y
         ...
         sinal_controle = nexttile;                                      % Gráfico do sinal de controle
         %p5_a = plot(sinal_controle,t1,u1','LineWidth',w);              % Plot do sinal de controle do sistema 1
         p5_a = plot(sinal_controle,t1,u1','-r','LineWidth',w);          % Plot do sinal de controle do sistema 1
         hold(sinal_controle,'on');                                      % Retém o gráfico
         %p5_b = plot(sinal_controle,t1,u2','LineWidth',w);              % Plot do sinal de controle do sistema 2
         p5_b = plot(sinal_controle,t1,u2',':b','LineWidth',w);          % Plot do sinal de controle do sistema 2
         legend(sinal_controle,legenda2,legenda3,'FontSize',v);          % Legenda do gráfico
         xlabel(sinal_controle,'Tempo [s]','FontSize',v);                % Texto do eixo x
         ylabel(sinal_controle,'Sinal de Controle','FontSize',v);        % Texto do eixo y
         grid(sinal_controle,'on');                                      % Habilita a grade
         ...
         hold(erro_estimativa1,'on');                                    % Retém o gráfico % Libera o gráfico
         %p6_b = plot(erro_estimativa1,t1,e2(1,:)','LineWidth',w);       % Plot do erro de estimativa do ângulo da haste entre o sistema 1 e seus estimador  ,'-r' 1':b',
         ...
         erro_estimativa2 = nexttile;                                    % Gráfico dos sinais de erro para o ângulo da haste
         %p7_a = plot(erro_estimativa2,t2,e(2,:)','LineWidth',w);        % Plot do erro de estimativa da posição do carrinho entre o sistema 1 e seu estimador  ,'-r'
         ...
         hold(erro_estimativa2,'on');                                    % Retém o gráfico
         %p7_b = plot(erro_estimativa2,t2,e2(2,:)','LineWidth',w);       % Plot do erro de estimativa do ângulo da haste entre o sistema 1 e seu estimador  ,'-r' 1':b',
